//import LinearProbing.HashEntry;

//import LinearProbingHashTable.HashEntry;
...
public class DoubleHashing<AnyType>
{
     ...
     */
    private int findPos( AnyType x )   /////// CHANGE STUFF IN HERE
    {
        int offset = hash2(x);
    ...
    {
        int hashVal2 = x.hashCode( );

        hashVal2 = 7 - (hashVal2 % 7)*7;
        if( hashVal2 < 0 )
